# Generated by Django 2.2.16 on 2022-06-08 08:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('anon', 'Anonymous User'), ('user', 'Authenticated User'), ('moderator', 'Moderator'), ('admin', 'Administrator')], default='user', max_length=9)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(help_text='Используйте формат: <ГГГГ>', validators=[django.core.validators.MaxValueValidator(2022)], verbose_name='Год создания')),
